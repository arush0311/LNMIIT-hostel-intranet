...
if (!empty($_POST)) {
    ...
    $query        = " SELECT 3 FROM students WHERE username = :user";
    ...
    $query = "INSERT INTO students ( fullname,username, password,email,contact ) VALUES ( :fullname,:user, :pass ,:email,:contact) ";
