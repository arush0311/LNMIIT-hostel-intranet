...
if (!empty($_POST)) {
    ...
    $query        = " SELECT 3 FROM teachers WHERE username = :user";
    ...
    $query = "INSERT INTO teachers ( fullname,username, password,email,contact) VALUES ( :fullname,:user, :pass,:email,:contact ) ";
